...
class BiSentiLR(object):
    ...
    def __init__(self, sess, vec_dim, nclasses, src_lr, trg_lr, src_bs,
                 trg_bs, src_epochs, trg_epochs, orthogonal):
        self.sess = sess
...
if __name__ == '__main__':
    ...
    parser.add_argument('-tlr', '--target_learning_rate', type=float, default=0.000000001, help='learning rate (default: 0.000001)')
